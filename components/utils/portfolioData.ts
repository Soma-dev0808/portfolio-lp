...
const portfolioData: PortfolioData = {
    ...
    portfolioSets: [
        ...
        },
        {
            ...
            difficultPart: "<span style='color: var(--primaryClr)'>It's not really hard part,</span> but I had to create a react custom hook for previous and next songs information to integrate play previous or next song feature. \n <span style='color: var(--primaryClr)'>After fetching playlist information,</span> the custom hook will find a current song information, and then find next and previous song information. Once previous and next songs' data is prepared, return them to where the custom hook is being called.",
            other: "",
