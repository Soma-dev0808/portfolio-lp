...
const portfolioData: PortfolioData = {
    ...
    portfolioSets: [
        {
            ...
            portfolioDesc: "<span style='color: var(--primaryClr)'>The real-time chat app</span> allows users to communicate with other users and check real-time status of other users in the same chat room. You can create or choose a chat room as well. \n <span style='color: var(--primaryClr)'>Built with</span> React, React-redux, Typescript, and CSS. Used Node.js and socket.io for handling real-time user status and text messaging.",
            portfolioId: "chatApp",
        ...
        },
        {
            ...
            portfolioDesc: "<span style='color: var(--primaryClr)'>In a card game concentration,</span> you find all matches of 2 cards within a limit time to win the game. You can change the difficulty and card design by clicking buttons in a header. Once you complete the game within a given time, you can post your score online to compete with other players. The score data is stored in the firebase store. \n <span style='color: var(--primaryClr)'>This application is</span> created with React.ts, and Vite boosted development server.",
            ...
            difficultPart: "<span style='color: var(--primaryClr)'>The rule for the card game</span> is pretty simple, but it was quite challenging for me to implement when it came to converting the card game rule into code. Especially, keeping card statuses, such as whether a card is flipped or not, was tough. \n <span style='color: var(--primaryClr)'>To overcome this,</span> I separated codes into small pieces as much as possible, which is more readable and easier to maintain so that I was able to avoid confusion while developing.",
            other: "",
    ...
    skillSets: [
        ...
        },
        {
            ...
            skillTitle: "Next.js",
            skillDesc: "I used Next.js when developing the Saas application to handle SSG and SSR in a company I worked for before. I also use next.js for my personal projects to boost web applications' performance and expand my web development skills. This landing page is also created by next.js."
        },
        {
            skillId: "nodejs",
            skillImg: "/assets/nodejs.png",
            skillTitle: "Node.js",
            skillDesc: "I have created some web applications with node.js in my previous company. I have experience of integrating REST APIs, third-party authentication, and push notification api. Also installed nodaemon to keep the server system alive to run notification api."
        },
        {
            skillId: "javascript",
            skillImg: "/assets/javascript.png",
            skillTitle: "Javascript",
            skillDesc: "Although I've been using React.js mainly for web development, javascript is also one of my powerful experiences. I have developed and had system update CRA application using javascript in my previous company. I also used jquery and AJAX to make a web page look richer."
        },
    ]
};
